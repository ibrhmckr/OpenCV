...
#from win32 import win32gui, win32api import win32con, ctypes, time
...
print(position)
#mouse.click((657, 444),"left")

#mouse.press_button((657, 444),"left",)

mouse.press_button((795, 786),"left",False)
time.sleep(2)
mouse.press_button((795, 786),"left",True)
